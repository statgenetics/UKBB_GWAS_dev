---
title: "Multi-variate Fine-Mapping with Summary Statistics (Mixture prior)"
author: "Jiayi Zhou"
output: 
  html_document:
    toc: TRUE
...
*The prior variance used in this notebook has been set to be an array of prior covariance matrices with equal weight.*  
...
mixture_prior_bi = list(weight = rep(1/3, 3), 
                       matrices = list(diag(2),m1,m2))
...
mixture_prior_tri = list(weight = rep(1/7, 7), 
                       matrices = list(diag(3),tri_m1,tri_m2,tri_m3,tri_m4,tri_m5,tri_m6))
